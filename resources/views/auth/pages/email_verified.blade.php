                  ...
                  <div class="col-md-7 d-flex flex-center">
                    <div class="p-4 p-md-5 flex-grow-1">
                      <div class="text-center"><img class="d-block mx-auto mb-4" src="/admin/assets/img/icons/spot-illustrations/16.png" alt="Email" width="100" />
                        <h3 class="mb-2">Veuillez vérifier votre e-mail !</h3>
                        <p>Un e-mail a été envoyé à votre adresse e-mail. Veuillez cliquer sur le <br class="d-none d-sm-block d-md-none" />lien inclus pour réinitialiser <span class="white-space-nowrap">votre mot de passe.</span></p><a class="btn btn-primary btn-sm mt-3" href="{{route('auth.login.view')}}"><span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4 down-1"></span>Retourner à la page de connexion</a>
                      </div>
                    </div>
                  </div>
                </div>
