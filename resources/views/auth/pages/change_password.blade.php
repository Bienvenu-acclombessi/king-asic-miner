              ...
              <div class="card-body p-0">
                <div class="row g-0 h-100">
                  ...
                  <div class="col-md-7 d-flex flex-center">
                    ...
                    @endif
                    @csrf
                        <div class="mb-3"><label class="form-label" for="card-reset-password">Nouveau mot de passe</label><input class="form-control" type="password" name="password" id="card-reset-password" /></div>
                        <div class="mb-3"><label class="form-label" for="card-reset-confirm-password">Confirmer le mot de passe</label><input class="form-control" type="password" name="password2" id="card-reset-confirm-password" /></div><button class="btn btn-primary d-block w-100 mt-3" type="submit" name="submit">Changer mot de passe</button>
                      </form>
                    </div>
                  </div>
                </div>
