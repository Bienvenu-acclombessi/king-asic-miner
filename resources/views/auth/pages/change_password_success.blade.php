                ...
                <div class="row g-0 h-100">
                  <div class="col-md-5 text-center bg-card-gradient">
                    ...
                    <div class="mt-3 mb-4 mt-md-4 mb-md-5" data-bs-theme="light">
                      <p class="mb-0 mt-4 mt-md-5 fs-10 fw-semi-bold text-white opacity-75">Lire nos <a class="text-decoration-underline text-white" href="#!">Conditions d'utilisation</a> et <a class="text-decoration-underline text-white" href="#!">Politiques de confidentialité </a></p>
                    </div>
                  </div>
                  <div class="col-md-7 d-flex flex-center">
                    <div class="p-4 p-md-5 flex-grow-1">
                      <div class="text-center"><img class="d-block mx-auto mb-4" src="/admin/assets/img/icons/spot-illustrations/16.png" alt="Email" width="100" />
                        <h3 class="mb-2">Mot de passe modifié avec succès!</h3>
                        <p>Votre mot de passe a été modifié !Vous pouvez désormais vous connecter avec ce mot de passe .</p><a class="btn btn-primary btn-sm mt-3" href="{{route('auth.login.view')}}"><span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4 down-1"></span>Retourner se connecter</a>
                      </div>
                    </div>
                  </div>
                </div>
