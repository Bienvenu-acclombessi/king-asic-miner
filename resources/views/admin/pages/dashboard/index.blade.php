...
<section
	...
	<div class="row mb-8">
		<div
			class="col-md-12">
			<!-- card -->
			<div class="card bg-light border-0 rounded-4" style="background-image: url(/assets/kingshop/assets/images/slider/slider-image-1.jpg); background-repeat: no-repeat; background-size: cover; background-position: right;">
	...
	<div class="row">
		<div
			class="col-lg-4 col-12 mb-6">
			<!-- card -->
			<div
				class="card h-100 card-lg">
				<!-- card body -->
				<div
					class="card-body p-6">
					<!-- heading -->
			...
			<div
				...
				<div
					...
					<div class="lh-1">
						...
						<span>
							<span class="text-dark me-1">35+</span>New Sales</span>
					</div>
				</div>
			</div>
		</div>
			...
			<div
				...
				<div
					...
					<div class="lh-1">
						...
						<span>
							<span class="text-dark me-1">30+</span>new in 2 days</span>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="row ">
		<div
			class="col-xl-8 col-lg-6 col-md-12 col-12 mb-6">
			<!-- card -->
		...
		<div
			class="col-xl-4 col-lg-6 col-12 mb-6">
			<!-- card -->
			<div
				class="card h-100 card-lg">
				<!-- card body -->
				<div
					class="card-body p-6">
					<!-- heading -->
					<h3 class="mb-0 fs-5">Total Sales
					</h3>
					...
					<div
						...
						<ul class="list-unstyled mb-0">
							<li class="mb-2">
								...
								<span class="ms-1">
									<span class="text-dark">Shippings
																									                                                        $32.98</span>
									(2%)</span>
							</li>
							<li class="mb-2">
	...
	<div class="row ">
		<div
			class="col-xl-6 col-lg-6 col-md-12 col-12 mb-6">
			<!-- card -->
			<div
				class="card h-100 card-lg">
				<!-- card body -->
				<div class="card-body p-6">
					<h3 class="mb-0 fs-5">Sales Overview
					</h3>
					<div
						class="mt-6">
						<!-- text -->
