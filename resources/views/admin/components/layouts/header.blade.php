							...
							<ul class="list-unstyled d-flex align-items-center mb-0 ms-5 ms-lg-0">
								...
								<li class="dropdown-center ">
									...
									<div class="dropdown-menu dropdown-menu-end dropdown-menu-lg p-0 border-0 ">
										...
										<div
											data-simplebar style="height: 250px;">
											<!-- List group -->
											<ul
												...
												<li class="list-group-item px-5 py-4 list-group-item-action active">
													<a href="#!" class="text-muted">
														<div class="d-flex">
															<img src="/assets/kingshop/assets/images/avatar/avatar-1.jpg" alt="" class="avatar avatar-md rounded-circle ">
															<div class="ms-4">
																<p class="mb-1">
												...
												<li class="list-group-item  px-5 py-4 list-group-item-action">
													<a href="#!" class="text-muted">
														<div class="d-flex">
															<img src="/assets/kingshop/assets/images/avatar/avatar-5.jpg" alt="" class="avatar avatar-md rounded-circle ">
															<div class="ms-4">
																<p class="mb-1">
												...
												<li class="list-group-item px-5 py-4 list-group-item-action">
													<a href="#!" class="text-muted">
														<div class="d-flex">
															<img src="/assets/kingshop/assets/images/avatar/avatar-2.jpg" alt="" class="avatar avatar-md rounded-circle ">
															<div class="ms-4">
																<p class="mb-1">
