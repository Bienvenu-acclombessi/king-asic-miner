...
<div class="py-6 p-md-6 p-lg-10">
            ...
            @include('client.pages.account.partials.delete_address_modal')
            @include('client.pages.account.partials.add_address_modal')
            @include('client.pages.account.partials.edit_address_modal')
@endsection
