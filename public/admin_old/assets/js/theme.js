...
var topProductsInit = function topProductsInit() {
  ...
  if ($echartBarTopProducts) {
    var data = [['Boots4', 43], ['Reign Pro', 83], ['Slick', 86], ['Falcon', 72], ['Sparrow', 80], ['Hideway', 50], ['Freya', 80]];
    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        ...
        tooltip: {
          ...
          formatter: function formatter(params) {
            return "<div class=\"font-weight-semi-bold\">".concat(params.name, ":</strong> ").concat(params.value, "</div>");
          }
        },
        legend: {
          data: ['2019'],
        ...
        xAxis: {
          type: 'category',
          data: utils.getData($echartBarTopProducts, 'labels'),
          axisLabel: {
            color: utils.getGrays()['400']
          },
          axisLine: {
        ...
        series: [{
          type: 'bar',
          data: utils.getData($echartBarTopProducts, 'values'),
          barWidth: '10px',
          barGap: '30%',
          label: {
            normal: {
...
var totalSalesEcommerce = function totalSalesEcommerce() {
  ...
  function getFormatter(params) {
    return params.map(function (_ref20) {
      ...
      return "\n          <span class= \"fas fa-circle\" style=\"color: ".concat(borderColor, "\"></span>\n          <span class='text-600'>").concat(seriesName === 'lastMonth' ? 'Mois dernier' : 'Previous Year', ": ").concat(value, "</span>\n        ");
    }).join('<br/>');
  }
  if ($echartsLineTotalSalesEcomm) {
    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        ...
        xAxis: {
          type: 'category',
          data: utils.getData($echartsLineTotalSalesEcomm, 'labels'),
          boundaryGap: false,
          axisPointer: {
            lineStyle: {
              color: utils.getColor('gray-300'),
        ...
        series: [{
          name: 'lastMonth',
          type: 'line',
          data: utils.getData($echartsLineTotalSalesEcomm, 'values'),
          lineStyle: {
            color: utils.getColor('primary')
          },
          itemStyle: {
